...
return [
    ...
    'timestamp' => 1562667820,
    'checksum' => 'd9d33ea2b5675e03faab65b253491b8c',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/admin-media-move' => [
                'file' => 'user/plugins/admin-media-move/blueprints.yaml',
                'modified' => 1561629878
            ],
            'plugins/email' => [
            ...
            'plugins/adminidenticons' => [
                'file' => 'user/plugins/adminidenticons/blueprints.yaml',
                'modified' => 1561629789
            ],
            'plugins/minify-html' => [
            ...
            'plugins/resmush' => [
                'file' => 'user/plugins/resmush/blueprints.yaml',
                'modified' => 1561720430
            ],
            'plugins/admin' => [
            ...
            'plugins/admin-media-actions' => [
                'file' => 'user/plugins/admin-media-actions/blueprints.yaml',
                'modified' => 1561629876
            ],
            'plugins/error' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.admin-media-move.enabled' => [
                'type' => 'toggle',
                'label' => 'Plugin status',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.admin-media-move.enabled',
                'validation' => 'strict'
            ],
            'plugins.email' => [
                'type' => '_root',
            ...
            'plugins.adminidenticons.enabled' => [
                'type' => 'toggle',
                'label' => 'Plugin Status',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'plugins.adminidenticons.enabled',
                'validation' => 'loose'
            ],
            'plugins.adminidenticons.type' => [
                'type' => 'select',
                'size' => 'small',
                'classes' => 'fancy',
                'label' => 'Avatar Type',
                ...
                'name' => 'plugins.adminidenticons.type',
                'validation' => 'loose'
            ],
            'plugins.adminidenticons.border_radius' => [
                'type' => 'range',
                'label' => 'Border Radius',
                ...
                'name' => 'plugins.adminidenticons.border_radius',
                'validation' => 'loose'
            ],
            'plugins.adminidenticons.background' => [
                'type' => 'colorpicker',
                'label' => 'Background color',
                'name' => 'plugins.adminidenticons.background',
                'validation' => 'loose'
            ],
            'plugins.adminidenticons.foreground' => [
                'type' => 'colorpicker',
                'label' => 'Foreground color',
                'name' => 'plugins.adminidenticons.foreground',
                'validation' => 'loose'
            ],
            'plugins.adminidenticons.varied' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.adminidenticons.varied',
                'validation' => 'loose'
            ],
            'plugins.adminidenticons.padding' => [
                'type' => 'range',
                'label' => 'Padding',
                ...
                'name' => 'plugins.adminidenticons.padding',
                'validation' => 'loose'
            ],
            'plugins.adminidenticons.spacing' => [
                'type' => 'range',
                'label' => 'Spacing',
                ...
                'name' => 'plugins.adminidenticons.spacing',
                'validation' => 'loose'
            ],
            'plugins.adminidenticons.rows' => [
                'type' => 'range',
                'label' => 'Rows',
                ...
                'name' => 'plugins.adminidenticons.rows',
                'validation' => 'loose'
            ],
            'plugins.adminidenticons.columns' => [
                'type' => 'range',
                'label' => 'Columns',
                ...
                'name' => 'plugins.adminidenticons.columns',
                'validation' => 'loose'
            ],
            'plugins.adminidenticons.tiles' => [
                'type' => 'range',
                'label' => 'Tiles',
                ...
                'name' => 'plugins.adminidenticons.tiles',
                'validation' => 'loose'
            ],
            'plugins.adminidenticons.colors' => [
                'type' => 'range',
                'label' => 'Colors',
                ...
                'name' => 'plugins.adminidenticons.colors',
                'validation' => 'loose'
            ],
            'plugins.minify-html' => [
                'type' => '_root',
            ...
            'plugins.admin-media-actions.enabled' => [
                'type' => 'toggle',
                'label' => 'Plugin status',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.admin-media-actions.enabled',
                'validation' => 'strict'
            ],
            'plugins.admin-media-actions.show_samples' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.admin-media-actions.show_samples',
                'validation' => 'strict'
            ],
            'plugins.error' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'admin-media-move' => [
                    'enabled' => 'plugins.admin-media-move.enabled'
                ],
                'email' => [
                ...
                'adminidenticons' => [
                    'enabled' => 'plugins.adminidenticons.enabled',
                    'type' => 'plugins.adminidenticons.type',
                    'border_radius' => 'plugins.adminidenticons.border_radius',
                    'background' => 'plugins.adminidenticons.background',
                    'foreground' => 'plugins.adminidenticons.foreground',
                    'varied' => 'plugins.adminidenticons.varied',
                    'padding' => 'plugins.adminidenticons.padding',
                    'spacing' => 'plugins.adminidenticons.spacing',
                    'rows' => 'plugins.adminidenticons.rows',
                    'columns' => 'plugins.adminidenticons.columns',
                    'tiles' => 'plugins.adminidenticons.tiles',
                    'colors' => 'plugins.adminidenticons.colors'
                ],
                'minify-html' => [
                ...
                'resmush' => [
                    'enabled' => 'plugins.resmush.enabled'
                ],
                'admin' => [
                ...
                'admin-media-actions' => [
                    'enabled' => 'plugins.admin-media-actions.enabled',
                    'show_samples' => 'plugins.admin-media-actions.show_samples'
                ],
                'error' => [
                ...
                'cdn' => [
                    ...
                    'forcehttps' => 'plugins.cdn.forcehttps',
